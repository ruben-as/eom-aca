  ...
  <li id="li-comment-<?php comment_ID(); ?>" <?php comment_class(); ?>>
    <div id="comment-<?php comment_ID(); ?>">
      ...
      <?php if ( '0' === $comment->comment_approved ) : ?>
        <p><em><?php esc_html_e( 'Your comment is awaiting approval.', 'eom-aca' ); ?></em></p>
      <?php endif; ?>
      ...
      <p class="comment-time">
        <a href="<?php echo esc_url( get_comment_link( $comment->comment_ID ) ); ?>">
          ...
          <time datetime="<?php echo esc_attr( get_comment_date( 'c' ) ); ?>"><?php printf( esc_attr( __( '%1$s at %2$s', 'eom-aca' ) ), esc_attr( get_comment_date() ), esc_attr( get_comment_time() ) ); ?></time>
        </a>
      </p>
      ...
      edit_comment_link( __( '&mdash; Edit', 'eom-aca' ), ' ', '' );
      ?>
