...
class Nav_Walker extends \Walker_Nav_Menu {
  ...
  public function start_el( &$output, $item, $depth = 0, $args = null, $id = 0 ) {
    ...
    // Add .dropdown or .active classes where they are needed.
		...
		$classes[] = 'eom-aca-menu-item menu-item-' . $item->ID;
		$classes[] = 'nav-item';
    ...
    $output .= apply_filters( 'walker_nav_menu_start_el', $item_output, $item, $depth, $args );
		...
		public static function fallback( $args ) {
			...
			$fallback_output .= '<li class="nav-item"><a href="' . esc_url( admin_url( 'nav-menus.php' ) ) . '" class="nav-link" title="' . esc_attr__( 'Add a menu', 'eom-aca' ) . '">' . esc_html__( 'Add a menu', 'eom-aca' ) . '</a></li>';
			$fallback_output .= '</ul>';
