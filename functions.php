...
add_action( 'after_setup_theme', function() {
  $theme_settings = [
     ...
     */
    'menu_locations' => [
      'primary' => __( 'Primary Menu', 'eom-aca' ),
    ],
     ...
     * https://github.com/digitoimistodude/eom-aca#custom-taxonomies
     */
    'taxonomies' => [
      // 'your-taxonomy' => [
      //   'name' => 'Your_Taxonomy',
     ...
     *
     * See the instructions:
     * https://github.com/digitoimistodude/eom-aca#custom-post-types
     */
    'post_types' => [
   ...
   //'allowed_blocks' => [
    ...
    'my_custom_setting' => false,
  ];

  $theme_settings = apply_filters( 'eom_aca_theme_settings', $theme_settings );
